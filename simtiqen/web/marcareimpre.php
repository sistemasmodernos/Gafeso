<?php
  ...
  inicio("marcareimpre");
  $res="";
  if(isset($_POST["ckmarca"]) && isset($_GET["do"]) && $_GET["do"]=="marcar")
  {
      $marcados=$_POST["ckmarca"];
      try{
      for($x=0;$x<count($marcados);$x++){
          $res.="Marcando ...". $x ."<br/>";
          MarcaReimpreTiq($marcados[$x],$_POST["txtanula"]);
      }
      
      $algo =count($marcados);
      $res.= " ".$algo." tiquetes marcados correctamente ";
     }
     catch(simError $ex){
         $res.=$ex->getMessage();
    }
...
<head>
  ...
  <title>Sistemas de ventas de tiquetes</title> 
        ...
        <link type="text/css" href="css/marcareimpre.css" rel="stylesheet" />       
  		<link type="text/css" href="css/redmond/jquery-ui-1.8.13.custom.css" rel="stylesheet" />        
        <script type="text/javascript" src="js/sfunciones.js"></script>
		<script type="text/javascript" src="js/jquery-1.5.1.min.js"></script>
		<script type="text/javascript" src="js/jquery-ui-1.8.13.custom.min.js"></script>
        <script type="text/javascript" src="js/jquery.ui.datepicker-es.js"></script>
        <script type="text/javascript" src="js/marcareimpre.js"></script>
...
<form id='fmarcareimpre' name='fmarcareimpre' action='marcareimpre.php' method='post'>
     <h1>Marcar para reimprimir tiquetes</h1>
    <div id='divanular'>
     <p class='mensaje' <?php if(trim($res)=="") echo "style='display:none;' "; ?> ><?php echo $res; ?></p>
     
      Raz&oacute;n por la cual se van a reimprimir los tiquetes: <br/>
      <input type='text' name='txtanula' id='txtanula'><br/>
       <input type='submit' value='Marcar para reimpresi&oacute;n' onclick='marcar();'>
    </div>
