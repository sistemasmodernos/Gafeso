...
<form id='formremesa' method='post' action='remision.php'>
    ...
    <div id='divtitulo'>
      ...
      <?php
           ...
           for($x=0;$x<count($res);$x++)
           {
               ...
               echo "<hr style='width:150px;margin-top:25px;'>".$res[$x]["remitente"]."<br/>".$res[$x]["cedremi"]."</div>";
               echo "<div style='float:left;border-style-left:solid;width:170px;margin:5px;' > ";
               echo "<hr style='width:150px;margin-top:25px;'>".$res[$x]["destinatario"]."<br/>".$res[$x]["cedremi"]."</div>";
