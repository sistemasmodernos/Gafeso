...
<form name='formlasiento' method='post' action='encomicredito.php'>
<div id='controles'>
       ...
       <br/>
       Impresora: <select id='cbimpresora' onchange='cambiaimpresora(this.value);'>
        <?php
...
<div id='divdatos'>
<div id='divtitulo'>
      <p> Encomiendas a cr&eacute;dito<br/> Impresora 
      <?php 
...
<div id='divcuadro'>
    <?php
       $dat= ListaActivos("Encomienda",array(
                  "e.fecha between '".fechatoUTC($lfechai)."' and '".fechatoUTC($lfechaf)."' ",
                  "e.idimpresora=".$limpresora . " and e.idformapago=2 "
                  )) ;
       ...
       "<thead><tr><th>Gu&iacute;a</th><th>F.viaje</th><th>Hora</th><th>Cliente</th><th>Usuario</th><th>Monto</th></tr></thead>";
       $par ='xxxx';
       $total=0;
       ...
       "<thead><tr><th>Gu&iacute;a</th><th>F.viaje</th><th>Hora</th><th>Cliente</th><th>Usuario</th><th>Monto</th></tr></thead>";
           ...
           $cont++;
              ...
              echo "<tfoot><tr><th colspan='5'>Total</th><th>".number_format($total,2)."</th></tr></tfoot>";
       echo "</table></div>";
    ?>
</div>
</div>
