...
?>
	...
	<p align="center">
<?php	
    if (Mantenimiento("tipoviaje",array("destipoviaje"=>$destipoviaje,"activo"=>$activo),1) == true){
...
<div id="contenedor">
    ...
    <div id="tabla">
	<br />
    <form id="frmNuevo" name="frmNuevo" method="post" action="newtipoviaje.php" enctype="multipart/form-data" onSubmit="GrabarDatos(); return false">
    <p>
    <label>Tipo de Viaje<br />
    <input class="text" type="text" name="destipoviaje" id="destipoviaje" />
    </label>
	</p>
 	<br>
    <p>
