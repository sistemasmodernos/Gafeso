...
class CedulaJurSIC{
  ...
  function Cargar(){
    ...
    $consulta = sprintf($this->Seleccion()." from cedjursic where cedula = '%s'",sqlClearText($this->idCedula));
  ...
  function ListarActivos($filtro){
       ...
       $sql=$this->Seleccion() . $otrocampo ." from cedjursic ".$tira . $orden . " limit 0,100 ";
  //     echo $sql;
