...
<h2 style='margin:auto;width:400px;'>Mantenimiento de Productos<h2>
...
if(isset($_POST['submit'])){
   ...
   $consulta = ListaMantenimiento("producto",$elfiltro,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("producto",$elfiltro);
   $xbus = $_POST['buscar'];
}else{
   $consulta = ListaMantenimiento("producto",null,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("producto",null);
   $xbus = '';
}
?>
...
<form id="frmConsulta" name="frmConsulta" method="post" action="" onSubmit="GrabarDatos(); return false">
    ...
    <label>Incluir un nuevo registro</label>
          <span id="nuevo"><a href="newproducto.php"><img src="img/add.png" title="Agrega un nuevo registro" alt="Agregar dato" /></a></span></form>
...
if($consulta) {
	...
	$linea = $consulta[$i];
	?>
		  <tr id="fila-<?php echo $linea['idProducto'] ?>">
			  ...
			  <td><span class="modi"><a href="actproducto.php?idProducto=<?php echo $linea['idProducto'] ?>"><img src="img/database_edit.png" title="Editar el registro" alt="Editar" /></a></span></td>
			  <td><span class="dele"><a onClick="EliminarDato(<?php echo $linea['idProducto'] ?>); return false" href="eliproducto.php?idProducto=<?php echo $linea['idProducto'] ?>"><img src="img/delete.png" title="Elimina el registro seleccionado" alt="Eliminar" /></a></span></td>
		  </tr>
	<?php
	}
}
