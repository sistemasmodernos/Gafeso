...
<h2 style='margin:auto;width:400px;'>Mantenimiento de Paradas<h2>
...
if(isset($_POST['submit'])){
   ...
   $consulta = ListaMantenimiento("parada",$elfiltro,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("parada",$elfiltro);
   $xbus = $_POST['buscar'];
}else{
   $consulta = ListaMantenimiento("parada",null,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("parada",null);
   $xbus = '';
}
?>
...
<form id="frmConsulta" name="frmConsulta" method="post" action="" onSubmit="GrabarDatos(); return false">
    ...
    <label>Incluir un nuevo registro</label>
          <span id="nuevo"><a href="newparada.php"><img src="img/add.png" title="Agrega un nuevo registro" alt="Agregar dato" /></a></span></form>
...
if($consulta) {
	...
	$linea = $consulta[$i];
	?>
		  <tr id="fila-<?php echo $linea['idparada'] ?>">
			  <td><?php echo $linea['nombre'] ?></td>
			  <td><span class="modi"><a href="actparada.php?idparada=<?php echo $linea['idparada'] ?>"><img src="img/database_edit.png" title="Editar el registro" alt="Editar" /></a></span></td>
			  <td><span class="dele"><a onClick="EliminarDato(<?php echo $linea['idparada'] ?>); return false" href="eliparada.php?idparada=<?php echo $linea['idparada'] ?>"><img src="img/delete.png" title="Elimina el registro seleccionado" alt="Eliminar" /></a></span></td>
		  </tr>
	<?php
	}
}
