...
?>
	...
	<p align="center">
<?php	
    if (Mantenimiento("socio",array("nombre"=>$nomsocio,"cedula"=>$cedula,"correo"=>$correo,"activo"=>$activo),1) == true){
...
?>
    ...
    <div id="tabla">
	<br />
    <form id="frmNuevo" name="frmNuevo" method="post" action="newsocio.php" enctype="multipart/form-data" onSubmit="GrabarDatos(); return false">
    <p>
    <label>Nombre del socio<br />
    <input class="text" type="text" name="nomsocio" id="nomsocio" />
    </label>
	</p>
 	<br>
    <p>
