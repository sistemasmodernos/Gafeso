...
<head>
  ...
  <link rel="stylesheet" href="css/repd151.css" type="text/css" />
...
<form name='formd151' method='post' action='repd151.php'>
<div id='controles'>
...
<div id='datos'>
    <div class='titulo1'>Reporte para D151 desde el <?php echo $lfechai; ?> hasta el <?php echo $lfechaf; ?> </div>
    <table class='tablad151'>
        <thead>
        <tr>
          <th>C&eacute;dula</th><th>Nombre</th><th>Cantidad</th><th>Monto</th>
        </tr>
        </thead>
        <tbody>
        <?php
        $dat=RepoD151(fechatoUTC($lfechai),fechatoUTC($lfechaf));
         $tcantidad=0;
         $tmonto=0;
        ...
        <tfoot>
         <tr>
           <th colspan='2'>Total</th><th><?php echo $tcantidad; ?><th><?php echo number_format($tmonto,2); ?></th>
         </tr>
        </tfoot>
    </table>
</div>
