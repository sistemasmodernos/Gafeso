...
<head>
 ...
 <script type="text/javascript" src="js/encomiendas01.js"></script>        
 <script type="text/javascript">
   ...
   for($x=0;$x<count($lproductos);$x++)
    ...
    $(document).ready(function(){
      ...
      ajusta();   
      $('#txtactividad').change(function(){ validaActividad(); });              
...
<div>
  <div id='remitente'>
    <div>
      <input type="radio" name="ckafa" value="remitente" onChange="copiafa();" checked>Factura
    </div>
    <table>
      <thead>
        <tr>
    ...
    <tr>
      <td>C&eacute;dula</td>
      <td><input type='text' id='txtcedremi' name='txtcedremi' onchange='revisacedulare();copiafa();' >
       <a id='acedremi' onclick='decidenave("txtcedremi","#tcedremi"); ' href='#' > Buscar</a> 
     </td>
   </tr>
   <tr>
    <td>Nombre</td>
    <td><input type='text' id='txtnomremi' name='txtnomremi' onchange="copiafa();"></td>
  </tr>
  <tr>
    <td>Email</td>
    <td><input type='text' id='txtemailremi' name='txtemailremi' onchange="copiafa();" ></td>
  </tr>
  <tr>
...
<div id='destinatario'>
  <div>
      <input type="radio" name="ckafa" value="destinatario" onChange="copiafa();">Factura
    </div>
  <table>
    <thead>
      <tr>
  ...
  <tr>
    <td>C&eacute;dula</td>
    <td><input type='text' id='txtceddesti' name='txtceddesti'   onchange='revisacedulades();' >
...
<div id='factura'>
  <div>
      <input type="radio" name="ckafa" value="independiente" onChange="copiafa();">Factura
    </div>
    <table>
      <thead>
        <tr>
         <th colspan='2'>Para la factura</th>
       </tr>
     </thead>
     <tbody>
      <tr>
        <td>Tipo de ID</td>
        <td>  
          <select id="tipocedfa" name="tipocedfa" onchange="cambiatipocedula();">
            <option selected value="00">Impersonal</option>
            <option value="01">Persona F&iacute;sica</option>
            <option value="02">Persona Jur&iacute;dica</option>
            <option value="03">DIMEX</option>
    ...
    <tr>
      <td>C&eacute;dula</td>
      <td><input type='text' id='txtcedulafa' name='txtcedulafa' onchange='revisacedulafa();' >
       <a id='acedremi' onclick='decidenave("txtcedulafa","#tipocedfa"); ' href='#' > Buscar</a> 
     </td>
   </tr>
   <tr>
    <td>Nombre</td>
    <td><input type='text' id='txtnombrefa' name='txtnombrefa'></td>
  </tr>
  <tr>
    <td>Email</td>
    <td><input type='text' id='txtcorreofa' name='txtcorreofa' ></td>
  </tr>
  <tr>
    <td>C&oacute;digo Actividad</td>
    <td><input type='text' id='txtactividad' name='txtactividad' maxlength="6" placeholder="Código actividad"></td>
  </tr>
  <tr>
    <td colspan="2"><span id='spanactividad' style='color: green; margin-left: 10px;'></span><td>
  </tr>
</tbody>
</table>
<div id="datosparafe" style="display: none;">
...
<div id='otros' >
  <table class='tablatiq'>
   ...
   <tr>
    ...
    <tr>
      <td>IVA 
        <input type="number" name="txtporiva" id="txtporiva" style="width: 50px;margin-left:7px;" value="13" disabled >
        %
      </td>
      <td style="text-align:right;font-weight: bold;font-size: 120%;" >
      <input type='number' 
