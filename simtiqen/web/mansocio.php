...
<h2 style='margin:auto;width:400px;'>Mantenimiento de socioes<h2>
...
if(isset($_POST['submit'])){
   ...
   $consulta = ListaMantenimiento("socio",$elfiltro,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("socio",$elfiltro);
   $xbus = $_POST['buscar'];
}else{
   $consulta = ListaMantenimiento("socio",null,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("socio",null);
   $xbus = '';
}
?>
...
<form id="frmConsulta" name="frmConsulta" method="post" action="" onSubmit="GrabarDatos(); return false">
    ...
    <label>Incluir un nuevo registro</label>
          <span id="nuevo"><a href="newsocio.php"><img src="img/add.png" title="Agrega un nuevo registro" alt="Agregar dato" /></a></span>
...
if($consulta) {
	...
	$linea = $consulta[$i];
	?>
		  <tr id="fila-<?php echo $linea['idsocio'] ?>">
			  <td><?php echo $linea['Nombre'] ?></td>
			  <td><?php echo $linea['cedula'] ?></td>
			  <td><span class="modi"><a href="actsocio.php?idsocio=<?php echo $linea['idsocio'] ?>"><img src="img/database_edit.png" title="Editar el registro" alt="Editar" /></a></span></td>
			  <td><span class="dele"><a onClick="EliminarDato(<?php echo $linea['idsocio'] ?>); return false" href="elisocio.php?idsocio=<?php echo $linea['idsocio'] ?>"><img src="img/delete.png" title="Elimina el registro seleccionado" alt="Eliminar" /></a></span></td>
		  </tr>
	<?php
	}
}
