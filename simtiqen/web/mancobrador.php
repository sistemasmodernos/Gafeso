...
<h2 style='margin:auto;width:400px;'>Mantenimiento de Cobradores<h2>
...
if(isset($_POST['submit'])){
   ...
   $consulta = ListaMantenimiento("cobrador",$elfiltro,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("cobrador",$elfiltro);
   $xbus = $_POST['buscar'];
}else{
   $consulta = ListaMantenimiento("cobrador",null,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("cobrador",null);
   $xbus = '';
}
?>
...
<form id="frmConsulta" name="frmConsulta" method="post" action="" onSubmit="GrabarDatos(); return false">
    ...
    <label>Incluir un nuevo registro</label>
          <span id="nuevo"><a href="newcobrador.php"><img src="img/add.png" title="Agrega un nuevo registro" alt="Agregar dato" /></a></span></form>
</div>
<form id="frmDatos">
	<table>
   		<tr>
...
if($consulta) {
	...
	$linea = $consulta[$i];
	?>
		  <tr id="fila-<?php echo $linea['idcobrador'] ?>">
			  <td><?php echo $linea['nombre'] ?></td>
			  <td><?php echo $linea['cedula'] ?></td>
			  <td><span class="modi"><a href="actcobrador.php?idcobrador=<?php echo $linea['idcobrador'] ?>"><img src="img/database_edit.png" title="Editar el registro" alt="Editar" /></a></span></td>
			  <td><span class="dele"><a onClick="EliminarDato(<?php echo $linea['idcobrador'] ?>); return false" href="elicobrador.php?idcobrador=<?php echo $linea['idcobrador'] ?>"><img src="img/delete.png" title="Elimina el registro seleccionado" alt="Eliminar" /></a></span></td>
		  </tr>
	<?php
	}
}
