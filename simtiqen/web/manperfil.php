...
<h2 style='margin:auto;width:400px;'>Mantenimiento de Perfiles<h2>
...
if(isset($_POST['submit'])){
   ...
   $consulta = ListaMantenimiento("perfil",$elfiltro,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("perfil",$elfiltro);
   $xbus = $_POST['buscar'];
}else{
   $consulta = ListaMantenimiento("perfil",null,array("pagina"=>$pagina,"registros"=>$limite));
  	$registros = Paginas("perfil",null);
   $xbus = '';
}
?>
...
<form id="frmConsulta" name="frmConsulta" method="post" action="" onSubmit="GrabarDatos(); return false">
    ...
    <label>Incluir un nuevo registro</label>
          <span id="nuevo"><a href="newperfil.php"><img src="img/add.png" title="Agrega un nuevo registro" alt="Agregar dato" /></a></span></form>
...
if($consulta) {
	...
	$linea = $consulta[$i];
	?>
		  <tr id="fila-<?php echo $linea['idperfil'] ?>">
			  ...
			  <td><span class="modi"><a href="actperfil.php?idperfil=<?php echo $linea['idperfil'] ?>"><img src="img/database_edit.png" title="Editar el registro" alt="Editar" /></a></span></td>
			  <td><span class="dele"><a onClick="EliminarDato(<?php echo $linea['idperfil'] ?>); return false" href="eliperfil.php?idperfil=<?php echo $linea['idperfil'] ?>"><img src="img/delete.png" title="Elimina el registro seleccionado" alt="Eliminar" /></a></span></td>
		  </tr>
	<?php
	}
}
