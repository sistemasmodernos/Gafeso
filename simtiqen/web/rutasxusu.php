...
<head>
  ...
  <link rel="stylesheet" href="css/segu.css" type="text/css" />
        ...
        <script type="text/javascript" src="js/rutasxusu.js"></script>
...
<form name='forminixusu' method='post' action='inicioxusu.php'>
 <div id='controles'>
  ...
  <div id='detalle'>
<h1>Rutas permitidas por usuario</h1>
    <table id='tablamarca'>
       <thead>
       <tr>
       <th></th>
       ...
       <tbody>
       <?php 
          $lrutas=ListaActivos("Ruta",null);
          for($x=0;$x<count($lrutas);$x++){
            echo "
         <tr>
          <td> 
            <input type='checkbox' onclick=\"marca('".$lrutas[$x]["idruta"]."',this);\" ";
             echo (in_array($lrutas[$x]["idruta"],$aprobados))? "checked":""; 
             echo "> ".$lrutas[$x]["nombre"]."</input> 
          </td>
         </tr>
            ";
