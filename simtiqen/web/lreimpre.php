...
<form name='formlasiento' method='post' action='lreimpre.php'>
<div id='controles'>
...
<div id='divcuadro'>
    <table id='tabladatos'>
      <thead>
         <tr>
            <th>Usuario </th>
            <th>Fecha reimpresi&oacute;n</th>
            <th>Tiquete</th>
            <th>Fecha Tiquete</th>
            <th>Viaje </th>
            <th>Asiento</th>
      ...
      <tbody>
   <?php 
       $dat = ListaReimpresion(fechatoUTC($lfechai),fechatoUTC($lfechaf),"");
       for($x=0;$x<count($dat);$x++){
           echo "<tr>";
           echo " <td> ".$dat[$x]["nombre"]."</td>";
           echo " <td> ".$dat[$x]["fechareimpre"]."</td>";
